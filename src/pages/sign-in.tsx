  ...
  return (
    <main className="w-full min-h-screen flex overflow-y-hidden">
      <div className="relative flex-1 hidden items-center justify-center min-h-screen bg-transparent lg:flex">
        <div className="relative z-10 w-full max-w-lg">
          ...
          <div className="mt-10 space-y-3">
            ...
            <Separator className="bg-white/20 w-[100px]" />
            <p className="text-gray-300 text-md md:text-xl tracking-tight">
              Entre agora e mergulhe em desafios de programação que vão elevar suas competências ao próximo nível. Aprenda, pratique e domine a arte do código!
            </p>
        ...
        <div className="my-auto h-full">
          <div className="absolute inset-0 opacity-15 w-full bg-transparent bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]" />
          <img
            className="absolute inset-x-0 opacity-25 size-full"
            src={
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-full">
        <img
          className="absolute -top-20 opacity-75"
          src={
            "https://pipe.com/_next/image?url=%2Fassets%2Fimg%2Fhero-left.png&w=384&q=75"
          }
          width={1000}
        ...
        <div className="w-full max-w-md md:max-w-lg space-y-8 px-4  text-gray-600 sm:px-0 z-20">
          ...
          <div className="grid grid-cols-3 gap-x-3">
            <button
              className="group h-full flex dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset] border-white/10 items-center justify-center py-5 border rounded-lg hover:bg-transparent/50 duration-150 active:bg-transparent/50"
            >
              <svg
                className="w-5 h-5 group-hover:-translate-y-1 duration-300 transition-all"
                viewBox="0 0 48 48"
                fill="none"
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5 z-20">
            <div>
              <Label className="font-medium text-gray-100/50">
                Nome
              </Label>
              <Input
                type="text"
            ...
            <button className="w-full text-center rounded-md bg-gradient-to-br opacity-90 hover:opacity-100 from-blue-400 to-blue-700 px-4 py-2 text-lg text-zinc-50 ring-blue-500/50 transition-all flex items-center justify-center gap-2">
              Criar conta
            </button>
          </form>
        </div>
